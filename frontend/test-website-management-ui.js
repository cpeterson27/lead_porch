...
for (const group of ["Publishing", "Public content", "Intro video", "Arrange your programs"]) assert(programs.includes(group));
...
assert(publicAdmin.includes("Poster image") && publicAdmin.includes("introVideoPosterUrl"));
