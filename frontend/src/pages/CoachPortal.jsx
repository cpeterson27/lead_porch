...
export function CoachDashboard() {
  ...
  return <div className="coaching-page"><PageHeader eyebrow="My Coaching" title={`Welcome${profile?.displayName ? `, ${profile.displayName}` : ""}`} description="Your authorized students and assignments. Lead Porch only shows coaching records assigned to you." />
...
export function CoachStudents({ upcoming = false }) {
  ...
  return <div className="coaching-page"><PageHeader eyebrow="My Coaching" title={upcoming ? "My upcoming students" : "My students"} description={upcoming ? "Students assigned to you for a future program stage." : "Only students backed by your current authorized CoachAssignments are shown."} />
...
export function CoachStudentDetail() {
  ...
  if (!student) return <div className="coaching-page"><PageHeader eyebrow="My Coaching" title="Student" description="Loading your authorized student record…" />{error ? <p className="coaching-notice coaching-notice--error">{error}</p> : null}</div>;
...
export function CoachSchedule() {
  ...
  return <div className="coaching-page"><PageHeader eyebrow="My Coaching" title="My schedule" description="Upcoming sessions use your selected Google Calendar and, when chosen, your connected Zoom account." />{error ? <p className="coaching-notice coaching-notice--error">{error}</p> : null}<CalendarConnection /><ZoomConnection />
