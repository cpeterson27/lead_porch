...
async function subscriptionChecks() {
  ...
  // identical to the Page's field list — confirmed live that adding
  // Instagram-specific field names here (comments, live_comments, mentions)
  // makes Meta reject the entire request, not just those fields.
  const grouped = [];
