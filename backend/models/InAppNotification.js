...
const inAppNotificationSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ["social_authorization", "social_automation_attention", "social_automation_triggered", "high_scoring_lead", "published_email", "monitor_complete", "source_failure", "source_disabled", "qualified_lead", "closer_assignment", "closer_follow_up", "privacy_request", "ambassador_profile_complete", "ambassador_welcome_ready", "ambassador_reminder", "coaching_application"], required: true },
